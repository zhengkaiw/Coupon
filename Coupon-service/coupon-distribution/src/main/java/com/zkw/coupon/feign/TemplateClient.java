...
import com.zkw.coupon.feign.hystrix.TemplateClientHystrix;
...
public interface TemplateClient {
    ...
    CommonResponse<Map<Integer, CouponTemplateSDK>> findIds2Template(@RequestParam("ids") Collection<Integer> ids);
}
